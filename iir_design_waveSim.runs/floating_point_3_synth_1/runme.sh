...
HD_PWD='C:/Users/ASUS/Documents/VivadoProjects/iir_design_waveSim/iir_design_waveSim.runs/floating_point_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log floating_point_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source floating_point_3.tcl
