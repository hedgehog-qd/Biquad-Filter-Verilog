...
#
# Generated by Vivado on Thu Oct 24 22:57:24 +0800 2024
# SW Build 2405991 on Thu Dec  6 23:38:27 MST 2018
#
# Copyright 1986-2018 Xilinx, Inc. All Rights Reserved. 
#
# usage: floating_point_3.sh [-help]
# usage: floating_point_3.sh [-lib_map_path]
# usage: floating_point_3.sh [-noclean_files]
# usage: floating_point_3.sh [-reset_run]
#
...
# executing this script. Please type 'floating_point_3.sh -help' for more information.
#
...
# Script info
echo -e "floating_point_3.sh - Script generated by export_simulation (Vivado v2018.3 (64-bit)-id)\n"
...
compile()
{
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../../iir_design_waveSim.srcs/sources_1/ip/floating_point_3/sim/floating_point_3.vhd" \
  2>&1 | tee -a vhdlan.log
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.floating_point_3 -o floating_point_3_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./floating_point_3_simv $vcs_sim_opts -do simulate.do
}
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./floating_point_3.sh -help\" for more information)\n"
        exit 1
      fi
...
reset_run()
{
  files_to_remove=(ucli.key floating_point_3_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc floating_point_3_simv.daidir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./floating_point_3.sh -help\" for more information)\n"
    exit 1
  fi
...
usage()
{
  msg="Usage: floating_point_3.sh [-help]\n\
Usage: floating_point_3.sh [-lib_map_path]\n\
Usage: floating_point_3.sh [-reset_run]\n\
Usage: floating_point_3.sh [-noclean_files]\n\n\
